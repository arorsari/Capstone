...
public class ProjectController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		res.setClient(request.getParameter("clientName"));
		...
		res.setTasks(request.getParameter("tasks"));
		res.setTeam(request.getParameter("team"));
		System.out.println(request.getParameter("clientName")+"--"+request.getParameter("projectName")+"--"+
				...
				request.getParameter("permissions")+"--"+request.getParameter("tasks")+"--"+
